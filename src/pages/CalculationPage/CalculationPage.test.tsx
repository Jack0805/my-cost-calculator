...
describe('CalculationPage Component', () => {
  ...
  it('renders without crashing', () => {
    ...
    expect(screen.getByText('Step 3. Payer owes each person the amounts listed')).toBeInTheDocument();
  });
  ...
  it('opens confirmation dialog when Reset button is clicked', () => {
    ...
    expect(screen.getByText(/are you sure you want to reset the calculation/i)).toBeInTheDocument();
  });
  ...
  it('displays the simplest settlement toggle switch', () => {
    ...
    expect(screen.getByText('Show simplest settlement way')).toBeInTheDocument();
  });
  ...
  it('switches between detailed and simplified settlement views', () => {
    ...
    const toggleSwitch = screen.getByRole('checkbox', { name: /show simplest settlement way/i });
